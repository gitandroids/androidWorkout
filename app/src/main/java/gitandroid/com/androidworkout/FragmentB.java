...
public class FragmentB extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof FragmentBListener) { // The context is our Activity.. Here we check if our Activity implements the interface.
            listener = (FragmentBListener) context; // We assign listener variable to the Activity with casting.
        } else {
